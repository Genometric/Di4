...
namespace OldDi3
{
    class Program
    {
        ...
        {
            List<OldDi3Main> di3 = new List<OldDi3Main>();
            for (int i = 0; i < 25; i++)
                di3.Add(new OldDi3Main());
            ...
            List<List<OldDi3Main.Map_Result>> map_Results = new List<List<OldDi3Main.Map_Result>>();
            ...
            using (System.IO.StreamWriter sw = new System.IO.StreamWriter("result.BED"))
            {
                ...
                {
                    foreach (OldDi3Main.Map_Result mpR in map_Results[chr])
                    {
                        sw.WriteLine(
                            "chr" + chr.ToString() + "\t" +
